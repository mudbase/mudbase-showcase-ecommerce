...
/**
 * A small path-pattern router — the "small router/dispatch file" the brief calls for, kept
 * separate from the per-route controller files it dispatches into. Supports `{param}` segments
 * only (no wildcards/regex authoring needed for this app's route list).
 */
final class Router
{
