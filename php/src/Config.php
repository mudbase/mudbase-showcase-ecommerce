 ...
 * once per process and exposes required/optional lookups. Mirrors the fail-fast behavior of
 * the reference Next.js app's src/lib/config.ts (requireEnv throws immediately on a missing var
