...
import 'checkout_proxy_service.dart';
...
final checkoutProxyServiceProvider = Provider<CheckoutProxyService>((ref) {
  return CheckoutProxyService(ref.watch(mudbaseSdkProvider));
});
