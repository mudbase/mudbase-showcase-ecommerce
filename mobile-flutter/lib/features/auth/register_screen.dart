...
/// Self-signup is always the `customer` role - matches the reference web
/// app's `RegisterForm` (role hidden, always `"customer"`). Seeding a
/// `seller` account is a one-time provisioning step, not a UI flow (there is
/// no self-service "become a seller" screen in this app by design - see
