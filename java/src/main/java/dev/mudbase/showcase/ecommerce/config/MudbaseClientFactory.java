 ...
 * pattern here, matching how the SDK docs show it being configured per use.
 */
@Component
public class MudbaseClientFactory {
  ...
  /** A client authenticated as the given end-user (customer, seller, or anonymous-guest) JWT. */
