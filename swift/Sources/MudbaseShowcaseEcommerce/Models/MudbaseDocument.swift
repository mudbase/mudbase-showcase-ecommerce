...
/// models (`Product`, `Order`, `CartRecord`) build themselves from this rather than each
/// hand-rolling their own `DataListResponseDataInner`-vs-`JSONValue` branching.
struct MudbaseDocument {
    ...
    func requiredString(_ key: String) -> String? { fields[key]?.stringValue }
