...
/// One-time configuration of the shared `MudbaseSDKAPIConfiguration` singleton every generated
/// API call reads by default (`apiConfiguration: MudbaseSDKAPIConfiguration = .shared`). Every
...
/// carry it automatically — the same mechanism the task brief describes for `X-API-Key`, applied
/// to a per-user JWT instead of a static project API key.
