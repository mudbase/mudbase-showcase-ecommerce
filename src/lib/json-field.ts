 ...
 * in a `string` field and parsed at the edges — this is a real, documented constraint of the
 * platform's Collections feature, not a workaround specific to this app.
 */
